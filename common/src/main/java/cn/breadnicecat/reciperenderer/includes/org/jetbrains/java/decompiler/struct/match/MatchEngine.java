...
package cn.breadnicecat.reciperenderer.includes.org.jetbrains.java.decompiler.struct.match;
...
import cn.breadnicecat.reciperenderer.includes.org.jetbrains.java.decompiler.struct.match.IMatchable.MatchProperties;
...
public class MatchEngine {
  ...
  @SuppressWarnings("SpellCheckingInspection")
  private static final Map<String, Statement.StatementType> stat_type = Map.of(
    "if", Statement.StatementType.IF,
    "do", Statement.StatementType.DO,
    "switch", Statement.StatementType.SWITCH,
    "trycatch", Statement.StatementType.TRY_CATCH,
    "basicblock", Statement.StatementType.BASIC_BLOCK,
    "sequence", Statement.StatementType.SEQUENCE);
