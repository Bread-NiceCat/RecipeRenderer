...
package cn.breadnicecat.reciperenderer.includes.org.jetbrains.java.decompiler.struct;

import cn.breadnicecat.reciperenderer.includes.org.jetbrains.java.decompiler.code.*;
import cn.breadnicecat.reciperenderer.includes.org.jetbrains.java.decompiler.struct.attr.StructCodeAttribute;
...
import static cn.breadnicecat.reciperenderer.includes.org.jetbrains.java.decompiler.code.CodeConstants.*;
		...
		for (int i = 0; i < length; ) {
			...
			if (opcode >= opc_iconst_m1 && opcode <= opc_iconst_5) {
				...
				switch (opcode) {
					...
					case opc_sipush, opc_ifeq, opc_ifne, opc_iflt, opc_ifge, opc_ifgt, opc_ifle, opc_if_icmpeq,
					     opc_if_icmpne, opc_if_icmplt,
					     opc_if_icmpge, opc_if_icmpgt, opc_if_icmple, opc_if_acmpeq, opc_if_acmpne, opc_goto, opc_jsr,
					...
					case opc_ldc_w, opc_ldc2_w, opc_getstatic, opc_putstatic, opc_getfield, opc_putfield,
					     opc_invokevirtual, opc_invokespecial,
