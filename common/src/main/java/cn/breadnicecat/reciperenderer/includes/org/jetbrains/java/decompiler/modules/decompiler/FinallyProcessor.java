...
import cn.breadnicecat.reciperenderer.includes.org.jetbrains.java.decompiler.modules.decompiler.exps.AssignmentExprent;
...
import cn.breadnicecat.reciperenderer.includes.org.jetbrains.java.decompiler.modules.decompiler.sforms.SSAConstructorSparseEx;
import cn.breadnicecat.reciperenderer.includes.org.jetbrains.java.decompiler.modules.decompiler.stats.BasicBlockStatement;
import cn.breadnicecat.reciperenderer.includes.org.jetbrains.java.decompiler.modules.decompiler.stats.CatchAllStatement;
...
import cn.breadnicecat.reciperenderer.includes.org.jetbrains.java.decompiler.code.SimpleInstructionSequence;
import cn.breadnicecat.reciperenderer.includes.org.jetbrains.java.decompiler.code.cfg.BasicBlock;
import cn.breadnicecat.reciperenderer.includes.org.jetbrains.java.decompiler.code.cfg.ControlFlowGraph;
import cn.breadnicecat.reciperenderer.includes.org.jetbrains.java.decompiler.code.cfg.ExceptionRangeCFG;
...
import cn.breadnicecat.reciperenderer.includes.org.jetbrains.java.decompiler.modules.code.DeadCodeHelper;
...
public class FinallyProcessor {
  ...
  public boolean iterateGraph(StructClass cl, StructMethod mt, RootStatement root, ControlFlowGraph graph) {
    ...
    while (!stack.isEmpty()) {
      ...
      if (parent != null && parent.type == Statement.StatementType.CATCH_ALL &&
    ...
    while (!stack.isEmpty()) {
      ...
      if (blockStatement != null && blockStatement.getBlock() != null) {
        ...
        for (StatEdge edge : blockStatement.getSuccessorEdges(StatEdge.EdgeType.DIRECT_ALL)) {
          if (edge.getType() != StatEdge.EdgeType.REGULAR && handler.containsStatement(blockStatement)
